...
from app.router import auth, geometry_operations, test, administrative, ligfinder, parcel_maximizer, ligfinder_advanced, parcel_maximizer_advanced, geometry_operations_advanced, administrative_advanced
